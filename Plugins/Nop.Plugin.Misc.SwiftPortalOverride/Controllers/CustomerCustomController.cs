...
namespace Nop.Plugin.Misc.SwiftPortalOverride.Controllers
{
    ...
    public partial class CustomerCustomController : CustomerController
    {
        #region fields
