...
namespace NSS.Plugin.DiscountRules.ThirtyThousandLBS
{
    public partial class ThirtyThousandLBSDiscountRequirementRule : BasePlugin, IDiscountRequirementRule
    {
        #region Fields
        ...
        public ThirtyThousandLBSDiscountRequirementRule(IActionContextAccessor actionContextAccessor,
        ...
        public string GetConfigurationUrl(int discountId, int? discountRequirementId)
        {
            ...
            return urlHelper.Action("Configure", "DiscountRulesThirtyThousandLBS",
