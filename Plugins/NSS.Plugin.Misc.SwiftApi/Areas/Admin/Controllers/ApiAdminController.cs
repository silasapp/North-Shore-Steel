...
namespace NSS.Plugin.Misc.SwiftApi.Areas.Admin.Controllers
{
    [AuthorizeAdmin]
    ...
    public class ApiAdminController : BasePluginController
    {
        ...
        public IActionResult Settings()
        {
            ...
            return View($"~/Plugins/NSS.Plugin.Misc.SwiftApi/Areas/Admin/Views/ApiAdmin/Settings.cshtml", model);
        }
