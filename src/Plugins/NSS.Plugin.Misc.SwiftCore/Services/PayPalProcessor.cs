...
namespace NSS.Plugin.Misc.SwiftCore.Services
{
    public class PayPalProcessor
    {
        ...
        public async Task<(Order Order, string ErrorMessage)> CaptureAsync(SwiftCoreSettings settings, string orderId)
        {
            return await HandleFunctionAsync(settings, async () =>
            {
        ...
        public async Task<(object Order, string ErrorMessage)> VoidAsync(SwiftCoreSettings settings, string authorizationId)
        {
            return await HandleFunctionAsync(settings, async () =>
            {
